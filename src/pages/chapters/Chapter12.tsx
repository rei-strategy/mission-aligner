    ...
    <main className="flex-1 bg-[#E6E7E8] p-6">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <section className="bg-white rounded-xl p-8 shadow-lg">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Sustainability Planning</h2>
          <p className="text-gray-600 text-lg">Long-term strategies for maintaining and growing your sober living home business.</p>
        </section>
      </div>
    </main>
  );
