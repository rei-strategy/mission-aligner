            ...
            <section className="px-8">
              <Tabs defaultValue="mission" className="w-full">
                <TabsList className="w-full bg-white py-4 px-2 rounded-xl mb-6 shadow-sm">
                  ...
                  <TabsTrigger value="legal" className="flex-1 px-6 py-3 text-lg text-gray-700">
                    Legal Requirements
                  </TabsTrigger>
                  <TabsTrigger value="operations" className="flex-1 px-6 py-3 text-lg text-gray-700">
                    Operations Planning
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="legal">
                  <div className="grid gap-8 md:grid-cols-1">
                    <section className="bg-white rounded-xl p-8 shadow-lg">
                      <h2 className="text-3xl font-bold text-gray-800 mb-6">Legal & Compliance Guide</h2>
