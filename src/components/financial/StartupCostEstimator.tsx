  ...
  return (
    <Card className="bg-[#8E9196] border-gray-300">
      <CardHeader className="space-y-1">
        ...
        <p className="text-gray-200">Calculate your initial investment requirements</p>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {category.items.map((item, itemIndex) => (
                  <div key={item.name} className="space-y-2">
                    <Label htmlFor={`${category.category}-${item.name}`} className="text-gray-200">
                      {item.name}
                    </Label>
                    <Input
          ...
          <div className="pt-4 border-t border-gray-300">
            <div className="flex justify-between items-center">
              <span className="text-lg font-semibold text-gray-100">Total Estimated Cost:</span>
